package com.kaola.webview.remotewebview.progressbar;
...
import com.kaola.webview.utils.WebUtils;

public class WebProgressBar extends FrameLayout implements BaseProgressSpec {
     ...
     * 默认匀速动画最大的时长
     */
    public static final int MAX_UNIFORM_SPEED_DURATION = 5 * 1000;
    /**
     * 默认加速后减速动画最大时长
     */
    public static final int MAX_DECELERATE_SPEED_DURATION = 600;
    /**
     * 结束动画时长 ， Fade out 。
     */
    public static final int DO_END_ANIMATION_DURATION = 300;
